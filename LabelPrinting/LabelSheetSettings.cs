        ...
        private void ConfigureSettings(LabelKind lkLabelSheetProductCode)
        {
            ...
            switch (lkLabelSheetProductCode)
            {
                ...
                case LabelKind.J8173:
                    ...
                    break;
                case LabelKind.Savemor:
                    this.LabelWidth = 260;  // 70mm
                    this.LabelHeight = 268; // 115 mm

                    this.LabelColumns = 3;
                    this.LabelColumnSpacing = 16;

                    this.LabelRows = 2;
                    this.LabelRowSpacing = 181;

                    this.Margins = new Margins(0, 0, 287, 157); // 2,2,73,40
